...
export default function CashOnDeliveryBulkUpload({ screenName }) {
  const Options = [
  ...
  return (
    <div className="panel__conatainer">
      <div className="panel__heading">Cash On Delivery Bulk Upload</div>
        ...
        <div className="panel__main__add__product__col__xl">
          <div className="input__field">
            ...
            <div style={{ fontWeight: "300" }}>
              ...
              dolor accusamus dignissimos minus temporibus facilis libero
              placeat distinctio quam natus aspernatur facere cum autem, ab
              animi voluptates, nobis quas dicta.
            </div>
          </div>
          <div className="input__field">
            <label htmlFor="" className="input__field__label">
            ...
            <InputboxComponent placeholder="USD" ClassName="input__box" />
          </div>
          <div className="input__field">
            <label htmlFor="" className="input__field__label">
              Upload List
